...
- [class: Puppeteer](#class-puppeteer) 提供Chromium的实例
  * [puppeteer.connect(options)](#puppeteerconnectoptions) 连接已经存在的Chromium
  * [puppeteer.createBrowserFetcher([options])](#puppeteercreatebrowserfetcheroptions) 下载Chromium
  * [puppeteer.defaultArgs()](#puppeteerdefaultargs) 启动Chromium时的默认参数
  * [puppeteer.executablePath()](#puppeteerexecutablepath) Chromium的可执行路径
  * [puppeteer.launch([options])](#puppeteerlaunchoptions) 启动Chromium
- [class: BrowserFetcher](#class-browserfetcher) 下载和管理不同版本的Chromium
  * [browserFetcher.canDownload(revision)](#browserfetchercandownloadrevision) 检查版本是否可用
  * [browserFetcher.download(revision[, progressCallback])](#browserfetcherdownloadrevision-progresscallback) 下载版本
  * [browserFetcher.localRevisions()](#browserfetcherlocalrevisions) 返回本地所有可用版本
  * [browserFetcher.platform()](#browserfetcherplatform) 返回平台类型
  * [browserFetcher.remove(revision)](#browserfetcherremoverevision) 删除版本
  * [browserFetcher.revisionInfo(revision)](#browserfetcherrevisioninforevision) 查询版本信息
- [class: Browser](#class-browser) extends EventEmitter
  * [event: 'disconnected'](#event-disconnected) disconnected from the Chromium instance
  * [event: 'targetchanged'](#event-targetchanged)  the url of a target changes.
  * [event: 'targetcreated'](#event-targetcreated) when a target is created, for example when a new page is opened by window.open or browser.newPage
  * [event: 'targetdestroyed'](#event-targetdestroyed) when a target is destroyed, for example when a page is closed.
  * [browser.close()](#browserclose) Closes Chromium and all of its pages
  * [browser.disconnect()](#browserdisconnect)
  * [browser.newPage()](#browsernewpage)
  * [browser.pages()](#browserpages) resolves to an array of all open pages
  * [browser.process()](#browserprocess) spawned browser process
  * [browser.targets()](#browsertargets)  an array of all active targets
